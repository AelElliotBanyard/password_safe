...
const page = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center font-serif h-screen w-screen overflow-hidden">
      <div className="overflow-y-scroll scrollbar scrollbar-thumb-[#225280] scrollbar-thumb-rounded-lg flex flex-col items-center ">
        <p className="text-5xl text-white font-bold font-serif p-10">
          Privacy Policy
        </p>
        <div className="flex flex-col gap-5 w-1/2 h-full pb-10">
          ...
          <p className="text-4xl font-bold">Interpretation and Definitions</p>
          <p className="text-3xl font-bold">Interpretation</p>
          <p>
          ...
          <p className="text-3xl font-bold">Definitions</p>
          ...
          <ul className="list-disc ml-8">
            ...
            <li>
              <b>Application</b> refers to Password Safe, the software program
              provided by the Company.
            </li>
            <li>
              <b>Company</b> (referred to as either "the Company", "We", "Us" or
              "Our" in this Agreement) refers to Password Safe.
            </li>
            <li>
              <b>Country</b> refers to: Switzerland
            </li>
            <li>
          ...
          <p className="text-3xl font-bold">Types of Date Collected</p>
          <p className="text-2xl font-bold">Personal Data</p>
          <p>
          ...
          <p className="text-2xl font-bold">Usage Data</p>
          ...
          <p className="text-3xl font-bold">Use of Personal Data</p>
          ...
          <p className="text-3xl font-bold">Retention of Your Personal Data</p>
          <p>
          ...
          <p className="text-3xl font-bold">Transfer of Your Personal Data</p>
          <p>
          ...
          <p className="text-3xl font-bold">Delete Your Personal Data</p>
          <p>
          ...
          <p className="text-3xl font-bold">Disclosure of Your Personal Data</p>
          <p className="text-2xl font-bold">Business Transactions</p>
          <p>
          ...
          <p className="text-2xl font-bold">Law enforcement</p>
          <p>
          ...
          <p className="text-2xl font-bold">Other legal requirements</p>
          <p>
          ...
          <p className="text-3xl font-bold">Security of Your Personal Data</p>
          <p>
          ...
          <p className="text-4xl font-bold">Children's Privacy</p>
          <p>
          ...
          <p className="text-4xl font-bold">Links to Other Websites</p>
          <p>
          ...
          <p className="text-4xl font-bold">Changes to this Privacy Policy</p>
          <p>
          ...
          <p>
            ...
            us by atom.aey.paw@gmail.com
          </p>
          <div className="w-full flex justify-center items-center pb-4">
            <div
              className=" border-white flex p-5 text-xl flex-row gap-2 border w-1/3  text-white rounded hover:bg-white hover:bg-opacity-30 items-center justify-center "
              onClick={handleBack}
            >
